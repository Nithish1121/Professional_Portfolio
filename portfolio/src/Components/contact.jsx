...
const Contact = () => {
  ...
  return (
    <div className="contactContainer">
      <div className="contactHeader">
        <h1 className="contactTitle" id="con_title">Contact</h1>
        <p className="contactSubtitle">Get in Touch</p>
      </div>

      <div className="contactContent">
        <div className="details" id="contact_details">
          <p><span className="deSub"><i className="fas fa-envelope"></i> Email:</span><br /><span className="deSubans">nithish8180@gmail.com</span></p>
          <p><span className="deSub"><i className="fas fa-map-marker-alt"></i> Location:</span><br /><span className="deSubans">Hyderabad, Telangana</span></p>
          <p><span className="deSub"><i className="fab fa-linkedin"></i> LinkedIn:</span><br /><span className="deSubans">http://linkedin.com/in/nithishkumar1121</span></p>
          <p><span className="deSub"><i className="fab fa-github"></i> GitHub:</span><br /><span className="deSubans">https://github.com/Nithish1121</span></p>
        </div>
